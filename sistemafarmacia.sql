...
--Select INNER JOIN com ORDEM BY ASC
...
DELETE FROM produto
WHERE codproduto = 4; /* ele deleta a linha inteira */
...
CREATE USER 'usuário_farmacia'@'localhost'
...
--Conecedendo permissão - apenas de leitura
GRANT SELECT
ON farmacianova.*
TO 'usuario_farmacia'@'localhost';

--Conecedendo permissões específicas
GRANT SELECT, INSERT
ON farmacianova.*
TO 'usuario_farmacia'@'localhost';
...
--testando código acima
SELECT * FROM vw_farmacia_produto;

--View: fármacia + farmacêutico
